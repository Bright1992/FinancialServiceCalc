...
def getRealtimeData(stock,year,month,day,opentime='09:30',morningclose='11:30',afternoonopen='13:00',closetime='15:01',interval=5):
    filename= 'txtfile\\%s_%04d_%d_%d.txt' % (stock, year, month, day)
    f=open(filename,'rU')
    ...
    # for ele in pool2:
    #     print(num2date(ele[0]))

    pool3=[]
    for ele in pool2:
        if (ele[0]<morningclose or ele[0]>=afternoonopen) and ele[0]<closetime:
            pool3.append(ele)
    print(len(pool3))
    # for ele in pool3:
    #     print(num2date(ele[0]))
...
# def getOrderSize(stock):
#     infile = open("%s.txt"%stock,'rU')
#     orders=[]
...
if __name__=='__main__':
    ...
    year=2016
    stock='sh601988'
    data=getRealtimeData(stock,year,month,day,interval=10)
