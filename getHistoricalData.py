...
def getHistoricalData(stock,year,month,day,opentime='09:30',morningclose='11:30',afternoonopen='13:00',closetime='15:01',interval=5):
    filename="%s_%04d_%d_%d.txt"%(stock,year,month,day)
    f=open(filename,'rU')
